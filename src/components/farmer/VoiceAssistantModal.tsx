...
const QUICK_CHIPS: Record<LanguageCode, { label: string; query: string }[]> = {
  te: [
    ...
    { label: '💳 చెల్లింపు', query: 'నా పేమెంట్ స్థితి ఏమిటి? నా ఖాతాకు ఎప్పుడు జమ అవుతుంది?' },
    { label: '🌾 నాణ్యత', query: 'తేమ శాతం ప్రమాణాలు ఏమిటి? నా ధాన్యం తిరస్కరించబడుతుందా?' },
    { label: '📄 J-ఫారం', query: 'J-ఫారం అంటే ఏమిటి? దాన్ని ఎలా పొందాలి?' },
    { label: '🏛️ PM-కిసాన్', query: 'PM కిసాన్ పథకం అర్హత ఏమిటి? ఎంత డబ్బు వస్తుంది?' },
    { label: '📝 స్లాట్', query: 'స్లాట్ ఎలా బుక్ చేయాలి? ఏ కేంద్రంలో ఆలస్యం తక్కువగా ఉంది?' },
  ],
  hi: [
    { label: '📍 नजदीकी केंद्र', query: 'मेरे नजदीक कौन सा खरीद केंद्र है? कितनी दूरी पर?' },
    { label: '💰 MSP दरें', query: 'इस साल धान, गेहूं, कपास की MSP दरें क्या हैं?' },
    { label: '🎫 मेरा टोकन', query: 'मेरा टोकन नंबर क्या है? मेरे आगे कितने किसान हैं?' },
    { label: '💳 भुगतान', query: 'मेरी भुगतान स्थिति क्या है? कब खाते में आएगा?' },
    { label: '🌾 गुणवत्ता', query: 'नमी प्रतिशत मानक क्या हैं? अनाज रिजेक्ट होगा क्या?' },
    { label: '📄 जे-फॉर्म', query: 'जे-फॉर्म क्या होता है? कैसे मिलेगा?' },
    { label: '🏛️ PM-किसान', query: 'PM किसान योजना की पात्रता और राशि क्या है?' },
    { label: '📝 स्लॉट', query: 'स्लॉट कैसे बुक करें? कहां कम भीड़ है?' },
  ],
  en: [
    { label: '📍 Nearest Centre', query: 'Which procurement centre is nearest to me? How far is it?' },
    { label: '💰 MSP Prices', query: 'What are the MSP rates for paddy, wheat and cotton this year?' },
    { label: '🎫 My Token', query: 'What is my token number and how many farmers are ahead of me?' },
    { label: '💳 Payment', query: 'What is my payment status? When will it be credited to my account?' },
    { label: '🌾 Quality Check', query: 'What are the moisture standards? Will my grain be rejected?' },
    { label: '📄 J-Form', query: 'What is a J-Form and how do I get it?' },
    { label: '🏛️ PM-KISAN', query: 'What is PM KISAN scheme eligibility and how much money do I get?' },
    { label: '📝 Book Slot', query: 'How do I book a slot? Which centre has the shortest queue?' },
  ],
  kn: [
    { label: '📍 ಹತ್ತಿರದ ಕೇಂದ್ರ', query: 'ನನ್ನ ಹತ್ತಿರ ಯಾವ ಖರೀದಿ ಕೇಂದ್ರ ಇದೆ? ದೂರ ಎಷ್ಟು?' },
    { label: '💰 MSP ದರ', query: 'ಈ ವರ್ಷ ಭತ್ತ, ಗೋಧಿ MSP ದರಗಳು ಏನು?' },
    { label: '🎫 ನನ್ನ ಟೋಕನ್', query: 'ನನ್ನ ಟೋಕನ್ ಸಂಖ್ಯೆ ಏನು? ನನ್ನ ಮುಂದೆ ಎಷ್ಟು ರೈತರಿದ್ದಾರೆ?' },
    { label: '💳 ಪಾವತಿ', query: 'ನನ್ನ ಪಾವತಿ ಸ್ಥಿತಿ ಏನು? ಯಾವಾಗ ಬ್ಯಾಂಕ್‌ಗೆ ಬರುತ್ತದೆ?' },
    { label: '🌾 ಗುಣಮಟ್ಟ', query: 'ತೇವಾಂಶ ಮಾನದಂಡಗಳು ಏನು? ನನ್ನ ಧಾನ್ಯ ತಿರಸ್ಕರಿಸಲ್ಪಡುತ್ತದೆಯೇ?' },
    { label: '📄 ಜೆ-ಫಾರ್ಮ್', query: 'ಜೆ-ಫಾರ್ಮ್ ಎಂದರೇನು? ಅದನ್ನು ಹೇಗೆ ಪಡೆಯಬೇಕು?' },
    { label: '🏛️ PM-ಕಿಸಾನ್', query: 'PM ಕಿಸಾನ್ ಯೋಜನೆ ಅರ್ಹತೆ ಮತ್ತು ಮೊತ್ತ ಏನು?' },
    { label: '📝 ಸ್ಲಾಟ್', query: 'ಸ್ಲಾಟ್ ಹೇಗೆ ಬುಕ್ ಮಾಡಬೇಕು? ಯಾವ ಕೇಂದ್ರದಲ್ಲಿ ಕಡಿಮೆ ಸರದಿ ಇದೆ?' },
  ],
  ta: [
    { label: '📍 அருகில் உள்ள மையம்', query: 'என் அருகில் உள்ள கொள்முதல் மையம் எது? எவ்வளவு தூரம்?' },
    { label: '💰 MSP விலை', query: 'இந்த ஆண்டு நெல், கோதுமை MSP விலை என்ன?' },
    { label: '🎫 என் டோக்கன்', query: 'என் டோக்கன் எண் என்ன? என் முன்னால் எத்தனை பேர்?' },
    { label: '💳 கட்டணம்', query: 'என் கட்டண நிலை என்ன? எப்போது கணக்கில் வரும்?' },
    { label: '🌾 தர சோதனை', query: 'ஈரப்பதம் தரநிலை என்ன? என் தானியம் நிராகரிக்கப்படுமா?' },
    { label: '📄 J-ஃபார்ம்', query: 'J-ஃபார்ம் என்றால் என்ன? அதை எப்படி பெறுவது?' },
    { label: '🏛️ PM-KISAN', query: 'PM KISAN திட்டம் தகுதி என்ன? எவ்வளவு பணம் கிடைக்கும்?' },
    { label: '📝 ஸ்லாட்', query: 'ஸ்லாட் எப்படி பதிவு செய்வது? எங்கே குறைவான வரிசை உள்ளது?' },
  ],
  bn: [
    { label: '📍 নিকটতম কেন্দ্র', query: 'আমার কাছের ক্রয় কেন্দ্র কোনটি? কত দূরে?' },
    { label: '💰 MSP মূল্য', query: 'এই বছর ধান, গম MSP মূল্য কত?' },
    { label: '🎫 আমার টোকেন', query: 'আমার টোকেন নম্বর কী? আমার সামনে কতজন কৃষক আছেন?' },
    { label: '💳 পেমেন্ট', query: 'আমার পেমেন্ট অবস্থা কী? কখন অ্যাকাউন্টে আসবে?' },
    { label: '🌾 মান পরীক্ষা', query: 'আর্দ্রতার মান কী? আমার শস্য প্রত্যাখ্যান হবে কি?' },
    { label: '📄 J-ফর্ম', query: 'J-ফর্ম কী এবং কীভাবে পাব?' },
    { label: '🏛️ PM-KISAN', query: 'PM KISAN যোগ্যতা এবং কত টাকা পাওয়া যায়?' },
    { label: '📝 স্লট', query: 'স্লট কীভাবে বুক করবেন? কোথায় কম ভিড় আছে?' },
  ],
};
